...
class CourseraDownloader(object):
    ...
    INFO_URL = 'https://www.coursera.org/course/%s'
    ...
    def courseInfo_url_from_name(self, course_name):
        '''Given the name of a course, return the course info page. 
        (The page that you can open without agreeing to the honor code).
        '''
        return self.INFO_URL % course_name
    ...
    #Functions added by me. Download the downloadable content without agree to the honor code.
    def download_info(self, cname, dest_dir = "."):
        '''
        download the course information in the introductory page.
        '''
        # open the main class page
        self.browser.open(self.INFO_URL % cname,timeout=self.TIMEOUT)

        # get the lecture url
        course_info_url = self.courseInfo_url_from_name(cname)
        ...
        self.download(course_info_url, target_dir=course_dir,target_fname="intro.html")
...
def main():  
    ...
    d = CourseraDownloader(
                            username = "liaoshi2001@gmail.com",
                            password = "EVArei2001",
                            ignorefiles = "srt"
                            )
    #The course name is not important, just to get started
    d.login("ml-007")
    d.download_info(cname = 'ml', dest_dir = "/Users/Greyjoy/Desktop")

    # # search for login credentials in .netrc file if username hasn't been provided in command-line args
    # username, password = "liaoshi2001@gmail.com", "EVArei2001"
    # if not username:
